...
const provider = 'https://basemaps.cartocdn.com/gl/dark-matter-gl-style/style.json';
...
const Marker = (
    ...
    return (
        <>
            <Show
                condition={!['none', 'submitted'].includes(props.gameState.currentMarker as string)}
            >
                <_Marker
                    latitude={(props.gameState.currentMarker as PlaceWithoutName).latitude}
                    longitude={(props.gameState.currentMarker as PlaceWithoutName).longitude}
                >
                    <Pin />
                </_Marker>
            </Show>
